...
3. **重要**：必須提供該法規的完整 HTTP/HTTPS 網址連結（例如：全國法規資料庫、法務部網站等官方來源）。
...
{
  "法條原文": "完整的法規條文原文",
  "出處來源": "完整的 HTTP/HTTPS 網址連結（必須是有效的網址，例如：https://law.moj.gov.tw/...）",
  "白話解析": "50字內的精簡直白說明",
  "查詢時間": "回應時間"
}

**注意**：「出處來源」欄位必須是完整的網址（以 http:// 或 https:// 開頭），不可只填寫文字說明。
