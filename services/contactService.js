...
const storage = admin.storage(); // 初始化 Firebase Storage
const bucket = storage.bucket(process.env.FIREBASE_STORAGE_BUCKET_NAME); // 需要在 .env 中配置您的 Storage Bucket 名稱，例如 'courtdata-b07ea.appspot.com'
